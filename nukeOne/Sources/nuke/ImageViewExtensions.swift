...
@discardableResult
public func globalLoadImage(with request: ImageRequestConvertible,
                      options: ImageLoadingOptions = ImageLoadingOptions.shared,
                      into view: ImageDisplayingView,
                      completion: @escaping ImageTask.Completion) -> ImageTask? {
    globalLoadImage(with: request, options: options, into: view, progress: nil, completion: completion)
}
